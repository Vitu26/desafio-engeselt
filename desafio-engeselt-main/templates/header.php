        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div>
                <div class="navbar-nav">
                    <a class="nav-link active" id="home-link" href="<?= $BASE_URL ?>home.php">Lista de Pedidos</a>
                    <a class="nav-link active" id="home-link2" href="<?= $BASE_URL ?>create.php">Adicionar Pedidos</a>
                    <a class="nav-link active" id="home-link3" href="<?= $BASE_URL ?>logoff.php">Sair</a>
                </div>
            </div>
        </nav>
    </header>